...
const documentSchema = new mongoose.Schema(
  {
    ...
    type: {
      ...
      enum: [
        ...
        'contract',              // Customer sends signed contract (Opening stage - Incoming)
        'id_files',              // Customer sends ID documents (Opening stage - Incoming)
        'contract_received_mail', // We confirm receipt of contract + ID (Opening stage - Outgoing)
        'opening_contract_client_email', // Opening contract email to client (Opening stage - Outgoing)
        'bank_confirmation',     // We confirm account opened + depot login (Confirmation stage - Outgoing)
        'annahme',               // We send bank details (Confirmation stage - Outgoing)
        'confirmation_email',    // Confirmation email to customer (Confirmation stage - Outgoing)
        'swift',                 // Customer sends payment voucher (Payment stage - Incoming)
        'swift_confirm_mail',    // We confirm receipt of payment (Payment stage - Outgoing)
        ...
        // Keep for existing documents, will be deprecated
        // ============================================
        'id',                    // Legacy: maps to id_files
        'extra',                 // Legacy: general extra documents
        'email',                 // Legacy: general email type
        'confirmation',          // Legacy: confirmation type
        'payment_voucher',       // Legacy: maps to swift
        'offer',                 // Legacy: offer type
        'opening',               // Legacy: opening type
        'offer-contract',        // Legacy: stage-prefixed types
        'offer-extra',
        'offer-email',
        'offer-contact',
        'opening-contract',      // Legacy: maps to contract
        'opening-id',            // Legacy: maps to id_files
        'opening-extra',
        'opening-email',
        'opening-mail',
  ...
  },
  {
    ...
    indexes: [
      { filename: 'text', searchable_text: 'text', tags: 'text' },
      { library_status: 1 },
      { uploader_id: 1 },
      { 'assignments.entity_type': 1, 'assignments.entity_id': 1 },
      { createdAt: -1 },
    ],
  }
);
