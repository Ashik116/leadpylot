...
const OFFER_POPULATE_CONFIG = [
  ...
  {
    path: 'lead_id',
    select: 'contact_name lead_source_no status stage current_month email_from phone source_id offer_calls',
...
// Filter by both: offer has progress record AND offer's current stage matches
