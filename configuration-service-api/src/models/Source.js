...
/**
 * Source Schema
 * Represents a lead source (UTM source) in the system
 */
const SourceSchema = new mongoose.Schema(
  {
    ...
    color: {
      ...
      validate: {
        ...
        message: 'Color must be a hex code like #RGB, #RRGGBB, or #RRGGBBAA',
      },
    },
  },
  {
...
SourceSchema.index({ provider_id: 1, active: 1 });
SourceSchema.index({ active: 1, createdAt: -1 });
