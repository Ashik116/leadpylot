...
const TYPE_MAP = {
  success: {
    backgroundColor: 'bg-evergreen/50',
    titleColor: 'text-evergreen',
    textColor: 'text-evergreen',
    iconColor: 'text-evergreen',
    icon: <HiCheckCircle />,
  },
  info: {
    backgroundColor: 'bg-ocean-4',
    titleColor: 'text-ocean-2',
    textColor: 'text-ocean-2',
    iconColor: 'text-ocean-2',
    icon: <HiInformationCircle />,
  },
  warning: {
    backgroundColor: 'bg-ember/50',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          {title ? (
            <div className={classNames('mb-1 text-lg font-semibold', typeMap?.titleColor)}>
              {title}
            </div>
          ) : null}
          {children}
