...
const Radio = (props: RadioProps) => {
  ...
  const radioColor = customColorContext || 'text-sand-1';
  ...
  return (
    <label ref={labelRef} className={labelClass}>
      <span className="radio-wrapper relative">
        ...
        <svg
          viewBox="0 0 16 16"
          className="stroke-sand-1 fill-sand-1 pointer-events-none absolute top-2/4 left-2/4 mt-[0.75px] h-4 w-4 -translate-x-2/4 -translate-y-2/4 opacity-0 peer-checked:opacity-100"
