...
/** Skeleton matching the comment/note activity structure. */
export const CommentActivitySkeleton: React.FC<{ leadExpandView?: boolean }> = () => (
...
export default CommentActivitySkeleton;
