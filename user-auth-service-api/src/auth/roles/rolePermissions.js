...
const ROLE_PERMISSIONS = {
  ...
  [ROLES.AGENT]: [
    ...
    PERMISSIONS.KANBAN_BOARD_READ_OWN,
    PERMISSIONS.KANBAN_BOARD_READ_ASSIGNED,
    PERMISSIONS.KANBAN_BOARD_UPDATE_OWN,
    PERMISSIONS.KANBAN_BOARD_DELETE_OWN,
    PERMISSIONS.KANBAN_BOARD_CREATE,

    // kanban list permissions
    PERMISSIONS.KANBAN_LIST_CREATE_OWN,
    PERMISSIONS.KANBAN_LIST_UPDATE_OWN,
    PERMISSIONS.KANBAN_LIST_DELETE_OWN,

    // kanban task permissions
    PERMISSIONS.KANBAN_TASK_READ_OWN,
    PERMISSIONS.KANBAN_TASK_READ_ASSIGNED,

    // Office: agents can read offices (e.g. list, view)
    PERMISSIONS.OFFICE_READ_ASSIGNED, 
    PERMISSIONS.OFFICE_ASSIGN_EMPLOYEE,
    // For attachments, agents can view and read attachment info
    // Required for notification audio playback (custom notification sounds)
    // Per-document access control is enforced in the controller (getAttachmentDetails)
    PERMISSIONS.ATTACHMENT_VIEW,
    PERMISSIONS.ATTACHMENT_READ,

    // PDF Service
    PERMISSIONS.PDF_GENERATION_CREATE,
    PERMISSIONS.PDF_GENERATION_READ,
    PERMISSIONS.PDF_GENERATION_UPDATE,
    PERMISSIONS.PDF_GENERATION_DELETE,
    PERMISSIONS.PDF_TEMPLATE_CREATE,
    PERMISSIONS.PDF_TEMPLATE_READ,
    PERMISSIONS.PDF_TEMPLATE_UPDATE,
    PERMISSIONS.PDF_TEMPLATE_DELETE,
    PERMISSIONS.FONT_MANAGEMENT_CREATE,
    PERMISSIONS.FONT_MANAGEMENT_READ,
